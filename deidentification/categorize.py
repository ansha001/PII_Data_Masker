...
def detect_document_type(text):
    ...
    if word_count == 0:
        # Handle the case when there are no words in the text
        return 'Unknown Document Type'
    
    max_percent = max(legal_percentage, financial_percentage, medical_percentage,rqa_percentage)

    # threshold of 5% for words detected in each class
    
    if max_percent == legal_percentage and legal_percentage>=5:
    ...
    elif max_percent == financial_percentage and financial_percentage>=5:
    ...
    elif max_percent == medical_percentage and medical_percentage>=5:
    ...
    elif max_percent == rqa_percentage and rqa_percentage>=5:
...
def extract_words_from_document(file):
    ...
    if file_extension == 'pdf':
        ...
        words.extend(extract_words_from_image(file))
...
def extract_words_from_image(file):
